...
RUN apt-get update && \
  apt-get -y install supervisor git unzip zip lrzsz apache2 libapache2-mod-php5 mysql-server php5-mysql pwgen php-apc php5-mcrypt openssh-server && \
